...
- the Durable Object allows at most two simultaneous participants
...
- delivery is marked when the opposite participant connection is present

## Read And Disappear

- when the recipient decrypts and acknowledges a message, it enters `read`
